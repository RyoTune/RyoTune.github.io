...
import { Mod_Ryo, Mod_PersonaEssentials } from "../../../../types/game";
...
**Yona** comes with BGM project templates for mulitple games, making music replacement an incredibly easy process.

## Getting Started with Yona
...
3. In the **Track Panel**, can change two settings: the **File** to use for the track and its **Loop**.
...
1. Click the **Build** button in the top-right of the **Project Page** to build your music project/mod. Building does the following:
...
2. Once you see the **Build Success** notification, you're finished! Test your mod in-game, and if everything is working, congrats on your music mod! 🎉
